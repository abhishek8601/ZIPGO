    ...
    <ScrollView className="flex-1 bg-[#FFF8E0]">
      ...
      >
        ...
        <View className="ml-5 flex-1">
          ...
          <Text className="text-[14px] text-gray-700 mt-1">ID: {id}</Text>
        </View>
      </View>
      ...
      <View className="bg-white mx-5 mt-5 p-5 rounded-2xl shadow-sm">
        ...
        <Text className="text-[13px] text-gray-600 leading-5">
          This teacher profile can be expanded later with more information like
          address, qualifications, experience, attendance, and other school
          related details.
        </Text>
      </View>
    </ScrollView>
